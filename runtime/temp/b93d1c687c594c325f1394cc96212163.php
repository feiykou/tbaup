<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"D:\SoftDownload\wamp\www\tbaup\public/../application/admin\view\type\list.html";i:1536849200;s:72:"D:\SoftDownload\wamp\www\tbaup\application\admin\view\common\header.html";i:1536755456;s:72:"D:\SoftDownload\wamp\www\tbaup\application\admin\view\common\footer.html";i:1535296431;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<section class="layui-larry-box">
	<div class="larry-personal">
		...
		<div class="layui-inline" onclick="add('添加商品类型','<?php echo url('add'); ?>')">
			<a class="layui-btn layui-btn-normal newsAdd_btn">添加商品类型</a>
		</div>
                     ...
                     <table class="layui-table">
                        ...
                        <tbody class="news_content list-box-body">
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <a class="layui-btn layui-btn-mini tb_edit" onclick="edit('商品属性','<?php echo url('property/lst',['id'=>$data['id']]); ?>','800px','463px')"><i class="fa fa-id-card-o fa-fw"></i> 属性列表</a>
